...
export async function PostFooter({ post }: Props) {
  ...
  return (
    <>
      <Separator skew='forward' />
      <footer className='post-footer p-8 mt-4 mb-4 max-w-4xl skew-forward rounded-lg drop-shadow-lg'>
        <div className='flex justify-center gap-4 skew-backward'>
